...
var replies = [
"Rescuer",
"Which area are you currently covering?",
"How many rescuers are with you?",
"Okay now go to marked location"
];
...
if (message.trim() !== '') {
  ...
  <img src="profile3.jpg" alt="Your Profile Image" class="profile-img"> <!-- Your profile image -->
...
newMessage.innerHTML = `
  <img src="sold4.jpg" alt="Other Person's Profile Image" class="profile-img"> <!-- Other person's profile image -->
  <span class="sender">Officer:</span> <!-- Other person's name -->
...
var userData = {
username: "Rescuer",
profilePicture: "profile3.jpg" // URL to the user's profile picture
};
